        ...
        <div class="flex-1">
            ...
            <form on:submit|preventDefault={handleAddDocument} class="space-y-4">
                <div class="form-control">
                    ...
                    <input id="title" type="text" bind:value={title} placeholder="Titre" class="input input-bordered w-full" required />
                </div>
                ...
                <div class="form-control">
                    ...
                    <textarea id="content" bind:value={content} placeholder="Contenu" class="textarea textarea-bordered w-full" required></textarea>
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="theme" type="text" bind:value={theme} placeholder="Thème" class="input input-bordered w-full" required />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="documentType" type="text" bind:value={documentType} placeholder="Type de document" class="input input-bordered w-full" required />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="publishDate" type="date" bind:value={publishDate} class="input input-bordered w-full" required />
                </div>
        ...
        <div class="flex-1">
            ...
            <form on:submit|preventDefault={handleFileUpload} class="space-y-4">
                <div class="form-control">
                    ...
                    <input id="fileUpload" type="file" on:change={handleFileChange} class="file-input file-input-bordered w-full" required />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="maxLength" type="number" bind:value={maxLength} min="100" class="input input-bordered w-full" />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="fileTheme" type="text" bind:value={fileTheme} class="input input-bordered w-full" />
                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="overflow-x-auto">
                        <table class="table table-zebra w-full">
                            ...
                            <tbody>
                                {#each uploadResults as document}
                                    <tr>
                                        <td>{document.id}</td>
                                        <td>{document.title}</td>
                                        <td>{document.theme}</td>
                                        <td>{document.documentType || 'Non spécifié'}</td>
                                    </tr>
                                {/each}
                            </tbody>
                        </table>
