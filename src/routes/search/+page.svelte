			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<div class="form-control">
					...
					<span class="text-xs text-opacity-70"
						>Supprime les résultats sous le seuil de pertinence minimal</span
					>
				</div>
				...
				<div class="form-control">
					...
					<span class="text-xs text-opacity-70"
						>Convertit les scores entre 0 et 1 pour faciliter la comparaison</span
					>
				</div>
			...
			{#if searchResults.totalResults > 0}
				<div class="grid gap-4">
					{#each searchResults.results as result (result.chunkId)}
						<div
							class="card w-full text-left bg-base-100 shadow-md hover:shadow-xl hover:translate-y-[-2px] transition-all duration-300 border border-transparent hover:border-primary-100"
						>
							<div class="card-body">
								<div
									...
									onkeydown={(e) => {
										if (e.key === 'Enter' || e.key === ' ')
											navigateToDocument(result.documentId, result.chunkId);
									}}
								>
									...
									<div class="flex flex-wrap gap-2 mt-2">
										...
										<span class="badge badge-outline">
											Score: {searchResults.normalized
								...
								<details class="mt-2 cursor-pointer">
									<summary class="text-sm font-medium"> Détails du document </summary>
